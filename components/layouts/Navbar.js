  ...
  useEffect(() =>{
    ...
    return (
        <div className="mb-5 max-w-7xl">
          <div id="header" className=" w-full z-30 -top-1 bg-gray-100 fixed">
            ...
            <div className="lg:px-0  ">
                  <Link href="/" className=" coloring1 tracking-wide no-underline hover:no-underline " >
                      <div className="coloring1 py-1 px-4 2xl:px-0 font-bold text-lg lg:text-2xl">Top<span className='text-orange-500'>Research</span>Papers
        ...
        <div className='coloring'>
            <div className="px-2 2xl:px-0 max-w-7xl mx-auto flex md:justify-start items-center mt-0 py-3 ">  
            <div className='grid md:grid-cols-2 ' >
             <div className=' w-full flex order-1 flex-wrap'> <button onClick={menuset}>
              ...
              <Link href="/" className="   " >
                      <div className="py-1 px-4 2xl:px-0 font-bold text-lg text-white lg:text-2xl">Top<span className='text-orange-500'>Research</span>Papers
              ...
              {isOpen ? (
                    ...
                    <div className="px-2 py-1 capitalize  font-bold" >
                    <Link href="/services"  className="no-underline   font-bold ">SERVICE</Link></div>
                    <div className="px-2 py-1 capitalize  font-bold" >
                    <Link href="/questions"  className="no-underline   font-bold ">QUESTIONS</Link></div>
                        {/* <div className="px-2 py-1 capitalize  font-bold" >
                ...
                <div className="md:flex hidden justify-end px-2 2xl:px-0 items-center w-full order-2">
                      <nav className="md:flex items-center justify-between text-sm text-white font-semibold" >
                        <div className="px-2 py-1 flex justify-start capitalize " >
                        <Link href="/"  className="no-underline ">HOME</Link></div>
                        <div className="px-2 py-1 flex justify-start capitalize " >
                        <Link href="/services"  className="no-underline ">SERVICE</Link></div>
                        {/* <div className="px-2 py-1 flex justify-start capitalize " >
                        <Link href="/"  className="no-underline ">PRICING</Link></div> */}
                        <div className="px-2 py-1 flex justify-start capitalize " >
                        <Link href="/questions"  className="no-underline ">QUESTIONS</Link></div>
                        <div className="px-2 py-1 flex justify-start capitalize " >
                        <Link href="/aboutus"  className="no-underline ">ABOUT US</Link></div>
                        <div className="px-2 py-1 flex justify-start capitalize " >
                        <Link href="/blog"  className="no-underline ">BLOG</Link></div>
