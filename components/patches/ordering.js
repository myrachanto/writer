const Ordering = () => {
    return ( 
        ...
        <div className="max-w-7xl  2xl:mx-auto mx-6  text-white">
            ...
            <div className="flex justify-center items-center my-5"><button className="p-2 bg-white coloring1 rounded-lg w-20 mr-5">Login</button> or <button  className="p-2 bg-white bg-orange-500 rounded-lg w-40 ml-5">Order Now</button></div>
        </div>
        </div>
     );
}
